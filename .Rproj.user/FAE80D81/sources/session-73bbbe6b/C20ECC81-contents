...
1. Download the folder then unzip.
2. Open the `.Rproj` file in RStudio.
3. On R Console, run `renv::restore()`
4. Store your new file to plot in the `data` folder. Make sure it follows the format of the file (both the filename and content). Please see sample in the `data` folder.
